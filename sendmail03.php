...
if (isset($_POST['g-recaptcha-response'])) {
	...
	if (!$captcha) {
		...
		echo "<meta http-equiv='refresh' content='0;url=contact-03'>";
	}
	if (isset($_POST['sentmail03']) && $responseData->success) {
		...
		if ($mail) {
			...
			echo "<meta http-equiv='refresh' content='0;url=contact-03.php'>";
		} else {
