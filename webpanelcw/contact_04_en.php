...
$data_contact = $conn->prepare("SELECT * FROM contact_04_en WHERE id = :id");
...
if (isset($_POST['edit_contact'])) {
    ...
    $tel1 = $_POST['tel1'];
                ...
                $edit_contact = $conn->prepare("UPDATE contact_04_en SET company_name = :company_name, address = :address, tel1 = :tel1, email = :email WHERE id = :id");
                ...
                if ($edit_contact) {
                    ...
                    echo "<meta http-equiv='refresh' content='2;url=contact_04_en'>";
                } else {
                    echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-end">
                            <a href="contact_04"><button type="button" class="btn btn-edit1">TH</button></a>
                        </div>
                    </div>
                    <div class="card-body">
