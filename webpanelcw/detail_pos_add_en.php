...
if (isset($_POST['add-detail_pos'])) {
    ...
    if (empty($id)) {
        ...
        try {
            ...
            $detail_pos = $conn->prepare("INSERT INTO detail_pos_en (content, id)
                        VALUES(:content , :id )");
            $detail_pos->bindParam(":content", $content);
            $detail_pos->bindParam(":id", $id);
            $detail_pos->execute();
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="submit" name="add-detail_pos" class="btn btn-save">Save</button>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="container">
                                <div class="cer-name">
                                    ...
                                    <select class="form-control" name="position_name" id="">
