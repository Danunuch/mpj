...
$data_ref = $conn->prepare("SELECT * FROM catta_cer1");
$data_ref->execute();
$row_cer1 = $data_ref->fetchAll();


$data_certificate = $conn->prepare("SELECT * FROM certificate ORDER BY id DESC");
...
if (isset($_POST['edit-catta'])) {
    ...
    $edit_cer = $conn->prepare("UPDATE catta_cer1 SET cer_name = :cer_name WHERE cer_id = :cer_id");
...
if (isset($_POST['delete_cer'])) {
    ...
    $del_cer = $conn->prepare("DELETE FROM catta_cer1 WHERE cer_id = :id");
...
if (isset($_POST['delete_certi'])) {
    ...
    $del_certi = $conn->prepare("DELETE FROM certificate WHERE id = :id");
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-end">
                            <a href="cer_en"><button type="button" class="btn btn-edit1">EN</button></a>
                            <a href="cer_add"><button type="button" class="btn btn-edit1">Add</button></a>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <form method="post">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="flex-end">
                                <a href="certificate_add"><button type="button" class="btn btn-edit1">Add</button></a>
