...
$data_publi = $conn->prepare("SELECT * FROM publication_en ORDER BY id DESC");
$data_publi->execute();
                ...
                <form method="post">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="flex-end">
                                <a href="publication"><button type="button" class="btn btn-edit">TH</button></a>
                                <a href="publication_add_en"><button type="button" class="btn btn-add">Add</button></a>
