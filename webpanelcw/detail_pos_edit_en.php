...
$data_detail_pos = $conn->prepare("SELECT * FROM detail_pos_en");
...
if (isset($_GET['work_id'])) {
    $id = $_GET['work_id'];
    $detail_pos_data = $conn->prepare("SELECT * FROM detail_pos_en WHERE id_pos = :id_pos");
...
if (isset($_POST['edit_detail'])) {
    ...
    $detail_pos = $conn->prepare("UPDATE detail_pos_en SET content = :content, id = :id WHERE id_pos = :id_pos");
