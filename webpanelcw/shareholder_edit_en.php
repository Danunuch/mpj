...
if (isset($_GET['shareholder_id'])) {
    ...
    $shareholder_data = $conn->prepare("SELECT * FROM shareholder_en WHERE id = :id");
...
if (isset($_POST['edit-shareholder'])) {
    ...
    $sha = $conn->prepare("UPDATE shareholder_en SET company_name = :company_name, qty = :qty, percen = :percen WHERE id = :id");
