    ...
    if (in_array($fileActExt1, $allow)) {
        if ($img['size'] > 0 && $img['error'] == 0) {
            if (move_uploaded_file($img['tmp_name'], $filePath1)) {
                $edit_company = $conn->prepare("UPDATE company3_en SET content = :content, img = :img");
                ...
                if ($edit_company) {
                    ...
                    echo "<meta http-equiv='refresh' content='2;url=detail_company3_en'>";
                } else {
                    echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
        ...
        $edit_company = $conn->prepare("UPDATE company3_en SET content = :content ");
        $edit_company->bindParam(":content", $content);
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-header" style="display: flex ;justify-content: flex-end;">
                            ...
                            <div class="a">
                                <a href="detail_company3"><button type="button" class="btn btn-edit">TH</button></a>
