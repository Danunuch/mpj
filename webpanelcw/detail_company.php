...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $stmt = $conn->prepare("SELECT * FROM company1 WHERE id = :id");
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="box-lang">
                            <a href="company_en"><button type="button" class="btn btn-edit">EN</button></a>
                            <a href="company_edit"><button type="button" class="btn btn-edit1">Edit</button></a>
                        </div>
                    </div>
                        ...
                        <div class="title-img">
                            ...
                            <div id="gallery-cover">
                                <div class='box-edit-img-cover'>
                                    ...
                                    <img class='edit-img-cover' id='previewImg-cover' src='upload/upload_company/<?php echo $row_company1['intro_img']; ?>'>
                                </div>
                            </div>
                        </div>
                    </div>
