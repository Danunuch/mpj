...
if (isset($_GET['lang'])) {
  $lang = $_GET['lang'];
  if ($lang == "en") {
    $stmt = $conn->prepare("SELECT * FROM contact_01_en");
    $stmt->execute();
    $row_contact_01 = $stmt->fetch(PDO::FETCH_ASSOC);
  } else {
    $stmt = $conn->prepare("SELECT * FROM contact_01");
    $stmt->execute();
    $row_contact_01 = $stmt->fetch(PDO::FETCH_ASSOC);
  }
} else {
    ...
    <section id="page-section">
      <div class="container-xxl">
        ...
        <div class="text-center mb-5">
          <h3 class="text-warning"><?php echo $row_contact_01['company_name']; ?></h3>
        </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            ...
            <p><i class="icofont-google-map text-warning"></i> <?php echo $row_contact_01['address']; ?></p>
            <p class="mb-0"><i class="icofont-phone text-warning"></i> <?php if (isset($_GET['lang'])) {
                                                                          ...
                                                                          echo "โทรศัพท์ : ";
                                                                        } ?> <?php echo $row_contact_01['tel1']; ?></p>
            <p class="mb-0"><i class="icofont-envelope text-warning"></i> <?php if (isset($_GET['lang'])) {
                                                                            ...
                                                                            echo "อีเมล :";
                                                                          } ?> <?php echo $row_contact_01['email']; ?></p>
        ...
        <form method="POST" action="sendmail01.php">
          <div class="row mt-5">
            <div class="col-md-6">
            ...
            <div class="g-recaptcha" data-sitekey="6Le5m0EkAAAAAJvQtnudYiRZBY71xFuE50xciETa" style="display: flex;justify-content: center;"></div>
              ...
              <button type="submit" name='sentmail01' class="btn btn btn-dark btn-lg rounded-0 px-lg-5"><i class="icofont-send-mail"></i> ส่งข้อความ</button>
