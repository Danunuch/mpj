...
if (isset($_POST['g-recaptcha-response'])) {
	...
	if (!$captcha) {
		...
		echo "<meta http-equiv='refresh' content='0;url=contact-04'>";
	}
	if (isset($_POST['sentmail04']) && $responseData->success) {
		...
		if ($mail) {
			...
			echo "<meta http-equiv='refresh' content='0;url=contact-04.php'>";
		} else {
